...
async def debug_fastmcp_registration():
    ...
    print(f"   📋 Simple MCP dir: {[attr for attr in dir(simple_mcp) if 'tool' in attr.lower()]}")
    ...
    print(f"   📋 Server MCP dir: {[attr for attr in dir(server.mcp) if 'tool' in attr.lower()]}")
