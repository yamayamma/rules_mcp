...
class TestYAMLRuleStore:
    ...
    async def test_list_rules(self):
        ...
        global_rule = Rule(name="global_rule", scope=RuleScope.GLOBAL, action=RuleAction.ALLOW)
        project_rule = Rule(name="project_rule", scope=RuleScope.PROJECT, action=RuleAction.DENY)
